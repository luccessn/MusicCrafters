                ...
                <div className="relative">
                  <Zoom>
                    <img
                      src={imgsChange}
                      alt=""
                      className=" w-[350px] h-[350px]  ssmm:w-[300px]  ssmm:h-[400px] ssm:w-[400px]  ssm:h-[400px] sm:w-[500px] sm:h-[500px] object-cover rounded-lg cursor-zoom-in"
                    />
                  </Zoom>
                </div>
              )}
                    ...
                    <div className="flex flex-col gap-10 items-center justify-between mt-6">
                      ...
                      <div className="flex flex-row  ssm:flex-row gap-10 relative w-full ssm:w-[500px]  sfm:left-28 sfm:w-[600px] ">
                        <button
                          ...
                          className={` rounded-lg  text-white text-medium ssm:text-xl  ${
                            data.stock === "0"
                        ...
                        {data.stock === "0" ? null : (
                          <button
                            onClick={AddToCart}
                            disabled={data.stock === 0}
                            className={` transition  rounded-lg text-white text-medium ssm:text-xl  ${
                              data.stock === "0"
