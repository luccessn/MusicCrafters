  ...
  return (
    <>
      {props.images?.img1 ? (
        <div
          onClick={goDTL}
          className=" w-[260px]   h-[320px] mt-10 mmd:m-0  ssmm:w-[180px] ssmm:h-[320px] ssm:w-[250px] ssm:h-[320px]  sfm:w-[260px] sfm:h-[350px] smm:w-[320px] smm:h-[370px]  sm:w-[340px] sm:h-[400px] xxxl:w-[380px] xxxl:h-[500px] flex flex-col rounded-xl relative shadow hover:shadow-md transition"
        >
